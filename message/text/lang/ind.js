...
exports.wrongFormat = () => {
    return `Salah Goblok Makanya Cek *${prefix}menu*.`
}

exports.emptyMess = () => {
    return `Lu Mau Masukin Pesan apa Masukin Lah Tolol!`
}

exports.cmdNotFound = (cmd) => {
    return `Command *${prefix}${cmd}* Gada Tai!`
}
...
exports.ownerOnly = () => {
    return `Ini Cuma Buat Adit Dek !`
}

exports.doneOwner = () => {
    return `Dah Dit Selesai`
}

exports.groupOnly = () => {
    return `Ini cuma bisa dipake kalo di grub tod!`
}

exports.adminOnly = () => {
    return `Ngemis jadi admin dlu sono baru make!`
}

exports.notNsfw = () => {
    return `aktifin mode nsfw lu dulu , dasar pengocok!`
}

exports.nsfwOn = () => {
    return `Command NSFW berhasil *diaktifkan* Ngocok Lah sepuas anda dosa tanggung sendiri!`
}

exports.nsfwOff = () => {
    return `Command NSFW berhasil *dinonaktifkan*! tobat tod ya `
}

exports.nsfwAlready = () => {
    return `udh aktif govlok ngocok sana.`
}
...
exports.notPremium = () => {
    return `beli premium tod biar bisa pake.`
}
...
exports.adminAlready = () => {
    return `dia udh admin buat apa dikasih lagi tolol!`
}
...
Media lagi dikirim, Sabar Kontol...
    `
}
...
exports.musiclimit = () => {
    return `Kegedean Size music Nya Males gw!`
}

exports.videoLimit = () => {
    return `gede bat size vid nya males gw!`
}
...
Dia Lafi Afk Jan Di Ping kontol!
➸ *Alasan*: ${getReason}
➸ *Sejak*: ${getTime}
    `
}
